...
public class Assign6 {
	...
	private static void createproject()
	{
		try
		{
			...
			Thread.sleep(1000);
			o.findElement(By.id("projectPopup_projectNameField")).sendKeys("healthcare web automation");
			Thread.sleep(1000);
			o.findElement(By.xpath("//*[@id=\'projectPopup_commitBtn\']/div/span")).click();
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void createtask()
	{
		try
		{
			o.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[1]/div[3]/div/div[2]")).click();
			Thread.sleep(1000);
			o.findElement(By.xpath("/html/body/div[13]/div[1]")).click();
			Thread.sleep(1000);
			o.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys("login page automation");
			Thread.sleep(1000);
			o.findElement(By.xpath("//*[@id=\'createTasksPopup_commitBtn\']/div/span")).click();
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void deletetask()
	{
		try
		{
			o.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[2]/div[1]/table[1]/tbody/tr/td[2]/div/div[2]")).click();
			Thread.sleep(1000);
			o.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[1]/div[2]/div[3]/div/div/div[2]")).click();
			Thread.sleep(1000);
	...
	private static void deleteproject()
	{
		try
		{
			...
			Thread.sleep(1000);
			o.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[3]/div/div/div[2]")).click();
			Thread.sleep(1000);
			o.findElement(By.id("//*[@id=\'taskListBlock\']/div[4]/div[4]/div/div[3]/div")).click();
			Thread.sleep(1000);
			o.findElement(By.id("projectPanel_deleteConfirm_submitTitle")).click();
			Thread.sleep(1000);
		}catch(Exception e)
		{
